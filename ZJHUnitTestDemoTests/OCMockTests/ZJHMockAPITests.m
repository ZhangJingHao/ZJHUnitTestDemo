...
@interface ZJHMockAPITests : XCTestCase

@end

@implementation ZJHMockAPITests

#pragma mark - 1、创建模拟对象 Creating mock objects
...
- (void)testMockObjects {
    ...
    NSLog(@"%@%@%@%@%@", mockPerson, mockProtocol, strictMockClass, strictMockProtocol, partialMockPerson);
...
#pragma mark - 2、存根方法 Stubbing methods
/// 2、存根方法 Stubbing methods
...
#pragma mark - 3、验证交互 Verifying interactions
...
#pragma mark - 4、参数约束 Argument constraints
...
#pragma mark - 5、Mocking class methods 模拟类方法
...
- (void)testClassMethods {
    ...
    NSLog(@"%@%@%@%@%@", mockPerson, className1, instanceName, className2, className3);
...
#pragma mark - 6、部分模拟 Partial mocks
...
#pragma mark - 7、严格的模拟和期望 Strict mocks and expectations
...
#pragma mark - 10、局限性 Limitations
/// 10、局限性 Limitations
